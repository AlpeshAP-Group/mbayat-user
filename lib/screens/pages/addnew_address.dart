...
class _AddShippingAddressPageState extends State<AddShippingAddressPage> {
  ...
  DropdownMenuItem<String> buildCountryMenu(
    String item,
  ) =>
      DropdownMenuItem(
        value: item,
        child: Container(
          decoration: BoxDecoration(
              border: this.value1 != item
                  ? Border.all(
                      color: Color(0x19000000),
                      width: 1,
                    )
                  : null,
              color: this.value1 == item ? white : white),
          child: Column(
                ...
                child: Row(
                  children: [
                    Text(
                      item,
                      style: TextStyle(
                        color: this.value1 == item ? black : black,
                        fontFamily: 'Urbanist',
                        fontSize: 15,
  ...
  DropdownMenuItem<String> buildStateMenu(
    String item,
  ) =>
      DropdownMenuItem(
        value: item,
        child: Container(
          decoration: BoxDecoration(
              border: this.value2 != item
                  ? Border.all(
                      color: Color(0x19000000),
                      width: 1,
                    )
                  : null,
              color: this.value2 == item ? white : white),
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
                ...
                child: Row(
                  children: [
                    Text(
                      item,
                      style: TextStyle(
                        color: this.value2 == item ? black : black,
                        fontFamily: 'Urbanist',
                        fontSize: 15,
                        fontWeight: FontWeight.bold,
                      ),
